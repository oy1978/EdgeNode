...
func (this *WAFManager) ConvertWAF(policy *firewallconfigs.HTTPFirewallPolicy) (*WAF, error) {
	...
	// Sil action
	if policy.SilOptions != nil {
		w.DefaultSilAction = &SilAction{
			Life:              policy.SilOptions.Life,
			MaxFails:          policy.SilOptions.MaxFails,
			FailBlockTimeout:  policy.SilOptions.FailBlockTimeout,
			FailBlockScopeAll: policy.SilOptions.FailBlockScopeAll,
			CountLetters:      policy.SilOptions.CountLetters,
			UIIsOn:            policy.SilOptions.UIIsOn,
			UITitle:           policy.SilOptions.UITitle,
			UIPrompt:          policy.SilOptions.UIPrompt,
			UIButtonTitle:     policy.SilOptions.UIButtonTitle,
			UIShowRequestId:   policy.SilOptions.UIShowRequestId,
			UICss:             policy.SilOptions.UICss,
			UIFooter:          policy.SilOptions.UIFooter,
			UIBody:            policy.SilOptions.UIBody,
			Lang:              policy.SilOptions.Lang,
		}
	}
